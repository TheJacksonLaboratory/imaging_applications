...
## 5.2. Experimenting with input's _chunk sizes_
...
However, the count of segmented objects is less in smaller _chunks_ compared to larger _chunks_.
This is again related to edge artifacts reducing the effective count of objects close to the border of each _chunk_.
This problem could be solved in a similar manner as mentioned above by usng _overlapping_ pixels and relabeling algorithms.
